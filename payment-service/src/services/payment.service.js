...
const paymentProducer = require('../events/producer/payment.producer');
...
const handlePaymentCaptured = async (paymentOrder, gatewayPaymentId, paymentEntity) => {
     ...
     // Publish PAYMENT_SUCCESS event (booking-service consumes it)
...
const handlePaymentFailed = async (paymentOrder, gatewayPaymentId, paymentEntity) => {
     ...
     // Publish PAYMENT_FAILED event (booking-service consumes it)
